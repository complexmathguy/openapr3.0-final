 ...
 * <li>Improving the available of Program related services in the case of a Program business related service failing.</li>
 * <li>Exposes a simpler, uniform Program interface to the business tier, making it easy for clients to consume a simple Java object.</li>
 * <li>Hides the communication protocol that may be required to fulfill Program business related services.</li>
 * </ol>
 * <p>
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {
		...
		try {
        	...
        	// -------------------------------------- 
			if ( command.getProgramId() == null )
				command.setProgramId( UUID.randomUUID() );
			...
			LOGGER.log( Level.INFO, "return from Command Gateway for CreateProgramCommand of Program is " + command );
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {
        ...
        try {
        	...
        	// --------------------------------------
        	CompletableFuture<Program> futureEntity = queryGateway.query(new FindProgramQuery( new LoadProgramFilter( summary.getProgramId() ) ), ResponseTypes.instanceOf(Program.class));
    ...
    throws ProcessingException {
        ...
        try {
        	CompletableFuture<List<Program>> futureList = queryGateway.query(new FindAllProgramQuery(), ResponseTypes.multipleInstancesOf(Program.class));
     ...
     * @exception	ProcessingException
     */     
	public void assignIntervalPeriod( AssignIntervalPeriodToProgramCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignIntervalPeriod( UnAssignIntervalPeriodFromProgramCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void addToPayloadDescriptors( AssignPayloadDescriptorsToProgramCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromPayloadDescriptors( RemovePayloadDescriptorsFromProgramCommand command ) throws ProcessingException {		
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromTargets( RemoveTargetsFromProgramCommand command ) throws ProcessingException {		
	...
	private Program load( UUID id ) throws ProcessingException {
		program = ProgramBusinessDelegate.getProgramInstance().getProgram( new ProgramFetchOneSummary(id) );	
		return program;
	}
