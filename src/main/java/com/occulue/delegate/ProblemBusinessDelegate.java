 ...
 * <li>Improving the available of Problem related services in the case of a Problem business related service failing.</li>
 * <li>Exposes a simpler, uniform Problem interface to the business tier, making it easy for clients to consume a simple Java object.</li>
 * <li>Hides the communication protocol that may be required to fulfill Problem business related services.</li>
 * </ol>
 * <p>
 * @author your_name_here
 */
public class ProblemBusinessDelegate 
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {
		...
		try {
        	...
        	// -------------------------------------- 
			if ( command.getProblemId() == null )
				command.setProblemId( UUID.randomUUID() );
			...
			LOGGER.log( Level.INFO, "return from Command Gateway for CreateProblemCommand of Problem is " + command );
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {
        ...
        try {
        	...
        	// --------------------------------------
        	CompletableFuture<Problem> futureEntity = queryGateway.query(new FindProblemQuery( new LoadProblemFilter( summary.getProblemId() ) ), ResponseTypes.instanceOf(Problem.class));
    ...
    throws ProcessingException {
        ...
        try {
        	CompletableFuture<List<Problem>> futureList = queryGateway.query(new FindAllProblemQuery(), ResponseTypes.multipleInstancesOf(Problem.class));
	...
	private Problem load( UUID id ) throws ProcessingException {
		problem = ProblemBusinessDelegate.getProblemInstance().getProblem( new ProblemFetchOneSummary(id) );	
		return problem;
	}
