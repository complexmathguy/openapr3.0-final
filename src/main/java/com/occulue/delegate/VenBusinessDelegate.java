 ...
 * <li>Improving the available of Ven related services in the case of a Ven business related service failing.</li>
 * <li>Exposes a simpler, uniform Ven interface to the business tier, making it easy for clients to consume a simple Java object.</li>
 * <li>Hides the communication protocol that may be required to fulfill Ven business related services.</li>
 * </ol>
 * <p>
 * @author your_name_here
 */
public class VenBusinessDelegate 
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {
		...
		try {
        	...
        	// -------------------------------------- 
			if ( command.getVenId() == null )
				command.setVenId( UUID.randomUUID() );
			...
			LOGGER.log( Level.INFO, "return from Command Gateway for CreateVenCommand of Ven is " + command );
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {
        ...
        try {
        	...
        	// --------------------------------------
        	CompletableFuture<Ven> futureEntity = queryGateway.query(new FindVenQuery( new LoadVenFilter( summary.getVenId() ) ), ResponseTypes.instanceOf(Ven.class));
     ...
     */
    public List<Ven> getAllVen() 
    throws ProcessingException {
        List<Ven> list = null;

        try {
        	CompletableFuture<List<Ven>> futureList = queryGateway.query(new FindAllVenQuery(), ResponseTypes.multipleInstancesOf(Ven.class));
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromAttributes( RemoveAttributesFromVenCommand command ) throws ProcessingException {		
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromResources( RemoveResourcesFromVenCommand command ) throws ProcessingException {		
