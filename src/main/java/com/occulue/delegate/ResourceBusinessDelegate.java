 ...
 * <li>Improving the available of Resource related services in the case of a Resource business related service failing.</li>
 * <li>Exposes a simpler, uniform Resource interface to the business tier, making it easy for clients to consume a simple Java object.</li>
 * <li>Hides the communication protocol that may be required to fulfill Resource business related services.</li>
 * </ol>
 * <p>
    ...
    throws ProcessingException, IllegalArgumentException {
		...
		try {
			...
			if ( command.getResourceId() == null )
				command.setResourceId( UUID.randomUUID() );
    		...
    		// ---------------------------------------
    		// issue the CreateResourceCommand - by convention the future return value for a create command
        	// that is handled by the constructor of an aggregate will return the UUID 
    		// ---------------------------------------
        	completableFuture = commandGateway.send( command );
        	
			LOGGER.log( Level.INFO, "return from Command Gateway for CreateResourceCommand of Resource is " + command );
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {
        ...
        try {
        	...
        	// --------------------------------------
        	CompletableFuture<Resource> futureEntity = queryGateway.query(new FindResourceQuery( new LoadResourceFilter( summary.getResourceId() ) ), ResponseTypes.instanceOf(Resource.class));
    ...
    throws ProcessingException {
        ...
        try {
        	CompletableFuture<List<Resource>> futureList = queryGateway.query(new FindAllResourceQuery(), ResponseTypes.multipleInstancesOf(Resource.class));
     ...
     * @exception	ProcessingException
     */     
	public void addToAttributes( AssignAttributesToResourceCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromAttributes( RemoveAttributesFromResourceCommand command ) throws ProcessingException {		
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromTargets( RemoveTargetsFromResourceCommand command ) throws ProcessingException {		
	...
	private Resource load( UUID id ) throws ProcessingException {
		resource = ResourceBusinessDelegate.getResourceInstance().getResource( new ResourceFetchOneSummary(id) );	
		return resource;
	}
