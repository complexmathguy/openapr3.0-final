 ...
 * <li>Improving the available of Interval related services in the case of a Interval business related service failing.</li>
 * <li>Exposes a simpler, uniform Interval interface to the business tier, making it easy for clients to consume a simple Java object.</li>
 * <li>Hides the communication protocol that may be required to fulfill Interval business related services.</li>
 * </ol>
 * <p>
 * @author your_name_here
 */
public class IntervalBusinessDelegate 
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {
		...
		try {
        	...
        	// -------------------------------------- 
			if ( command.getIntervalId() == null )
				command.setIntervalId( UUID.randomUUID() );
    		...
    		// ---------------------------------------
    		// issue the CreateIntervalCommand - by convention the future return value for a create command
        	// that is handled by the constructor of an aggregate will return the UUID 
    		// ---------------------------------------
        	completableFuture = commandGateway.send( command );
        	
			LOGGER.log( Level.INFO, "return from Command Gateway for CreateIntervalCommand of Interval is " + command );
    ...
    */
    ...
    throws ProcessingException, IllegalArgumentException {
        ...
        try {
        	...
        	// --------------------------------------
        	CompletableFuture<Interval> futureEntity = queryGateway.query(new FindIntervalQuery( new LoadIntervalFilter( summary.getIntervalId() ) ), ResponseTypes.instanceOf(Interval.class));
    ...
    throws ProcessingException {
        ...
        try {
        	CompletableFuture<List<Interval>> futureList = queryGateway.query(new FindAllIntervalQuery(), ResponseTypes.multipleInstancesOf(Interval.class));
     ...
     * @exception	ProcessingException
     */     
	public void assignIntervalPeriod( AssignIntervalPeriodToIntervalCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     
	public void unAssignIntervalPeriod( UnAssignIntervalPeriodFromIntervalCommand command ) throws ProcessingException {
     ...
     * @exception	ProcessingException
     */     	
	public void removeFromPayloads( RemovePayloadsFromIntervalCommand command ) throws ProcessingException {		
	...
	private Interval load( UUID id ) throws ProcessingException {
		interval = IntervalBusinessDelegate.getIntervalInstance().getInterval( new IntervalFetchOneSummary(id) );	
		return interval;
	}
