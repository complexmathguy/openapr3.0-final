...
public class EventPayloadDescriptorTest{
	...
	protected void jumpStart() throws Throwable {
		...
		eventPayloadDescriptorId = EventPayloadDescriptorBusinessDelegate.getEventPayloadDescriptorInstance()
	...
	protected void setUpQuerySubscriptions() throws Throwable {
		...
		try {            
			subscriber.eventPayloadDescriptorSubscribe().updates().subscribe(
					  successValue -> {
						  LOGGER.info(successValue.toString());
						  try {
							  LOGGER.info("GetAll update received for EventPayloadDescriptor : " + successValue.getEventPayloadDescriptorId());
							  if (successValue.getEventPayloadDescriptorId().equals(eventPayloadDescriptorId)) {
								  if (testingStep.equals("create")) {
									  ...
									  state( getAll().size() == sizeOfEventPayloadDescriptorList - 1 , "value not deleted from list");
									  LOGGER.info("**********************************************************");
			...
			subscriber.eventPayloadDescriptorSubscribe( eventPayloadDescriptorId ).updates().subscribe(
					  successValue -> {
						  LOGGER.info(successValue.toString());
						  try {
							  LOGGER.info("GetOne update received for EventPayloadDescriptor : " + successValue.getEventPayloadDescriptorId() + " in step " + testingStep);
							  testingStep = "delete";
					  ...
					  error -> LOGGER.warning(error.getMessage()),
					  () -> LOGGER.info("Subscription on eventPayloadDescriptor for eventPayloadDescriptorId consumed")
	...
	protected EventPayloadDescriptor read() throws Throwable {
		...
		StringBuilder msg = new StringBuilder( "-- Failed to read EventPayloadDescriptor with primary key" );
		msg.append( eventPayloadDescriptorId );
		
		EventPayloadDescriptorFetchOneSummary fetchOneSummary = new EventPayloadDescriptorFetchOneSummary( eventPayloadDescriptorId );

		try {
			entity = EventPayloadDescriptorBusinessDelegate.getEventPayloadDescriptorInstance().getEventPayloadDescriptor( fetchOneSummary );
	...
	protected void update() throws Throwable {
		...
		try {            
			...
			EventPayloadDescriptorBusinessDelegate proxy = EventPayloadDescriptorBusinessDelegate.getEventPayloadDescriptorInstance();  
			...
			LOGGER.warning( unexpectedErrorMsg );
			LOGGER.warning( msg.toString() + " : primarykey = " + eventPayloadDescriptorId + " : command -" +  command + " : " + e );
	...
	protected void delete() throws Throwable {
		...
		try{
		    entity = read(); 
			LOGGER.info( "-- Successfully read EventPayloadDescriptor with id " + eventPayloadDescriptorId );            
		}
		catch ( Throwable e ) {
			LOGGER.warning( unexpectedErrorMsg );
			LOGGER.warning( "-- Failed to read EventPayloadDescriptor with id " + eventPayloadDescriptorId );

			throw e;
		}

		try{
			EventPayloadDescriptorBusinessDelegate.getEventPayloadDescriptorInstance().delete( new DeleteEventPayloadDescriptorCommand( entity.getEventPayloadDescriptorId() ) ).get();
			LOGGER.info( "-- Successfully deleted EventPayloadDescriptor with id " + eventPayloadDescriptorId );            
		}
		catch ( Throwable e ) {
			LOGGER.warning( unexpectedErrorMsg );
			LOGGER.warning( "-- Failed to delete EventPayloadDescriptor with id " + eventPayloadDescriptorId );
	...
	protected List<EventPayloadDescriptor> getAll() throws Throwable {    
		...
		try {
			...
			collection = EventPayloadDescriptorBusinessDelegate.getEventPayloadDescriptorInstance().getAllEventPayloadDescriptor();
			assertNotNull( collection, "An Empty collection of EventPayloadDescriptor was incorrectly returned.");
			...
			while( iter.hasNext() ) {
				...
				assertNotNull( entity.getEventPayloadDescriptorId(), "-- entity in Collection has a null primary key" );        
	...
	protected CreateEventPayloadDescriptorCommand generateNewCommand() {
        CreateEventPayloadDescriptorCommand command = new CreateEventPayloadDescriptorCommand( null,  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  ObjectType.values()[0] );
	...
	protected UpdateEventPayloadDescriptorCommand generateUpdateCommand() {
	        UpdateEventPayloadDescriptorCommand command = new UpdateEventPayloadDescriptorCommand( null,  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  org.apache.commons.lang3.RandomStringUtils.randomAlphanumeric(16),  ObjectType.values()[0] );
