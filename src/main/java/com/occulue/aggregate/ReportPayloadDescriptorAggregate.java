...
public class ReportPayloadDescriptorAggregate {  
    ...
    public ReportPayloadDescriptorAggregate(CreateReportPayloadDescriptorCommand command) throws Exception {
    	...
    	CreateReportPayloadDescriptorEvent event = new CreateReportPayloadDescriptorEvent(command.getReportPayloadDescriptorId(), command.getPayloadType(), command.getReadingType(), command.getUnits(), command.getAccuracy(), command.getConfidence(), command.getObjectType());
    ...
    public void handle(UpdateReportPayloadDescriptorCommand command) throws Exception {
    	...
    	UpdateReportPayloadDescriptorEvent event = new UpdateReportPayloadDescriptorEvent(command.getReportPayloadDescriptorId(), command.getPayloadType(), command.getReadingType(), command.getUnits(), command.getAccuracy(), command.getConfidence(), command.getObjectType());        
