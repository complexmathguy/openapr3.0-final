...
public class EventPayloadDescriptorAggregate {  
    ...
    public EventPayloadDescriptorAggregate(CreateEventPayloadDescriptorCommand command) throws Exception {
    	...
    	CreateEventPayloadDescriptorEvent event = new CreateEventPayloadDescriptorEvent(command.getEventPayloadDescriptorId(), command.getPayloadType(), command.getUnits(), command.getCurrency(), command.getObjectType());
    ...
    public void handle(UpdateEventPayloadDescriptorCommand command) throws Exception {
    	...
    	UpdateEventPayloadDescriptorEvent event = new UpdateEventPayloadDescriptorEvent(command.getEventPayloadDescriptorId(), command.getPayloadType(), command.getUnits(), command.getCurrency(), command.getObjectType());        
