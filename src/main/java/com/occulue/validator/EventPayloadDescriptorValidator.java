...
//		Assert.isNull( eventPayloadDescriptor.getEventPayloadDescriptorId(), "CreateEventPayloadDescriptorCommand identifier should be null" );
		Assert.notNull( eventPayloadDescriptor.getPayloadType(), "Field CreateEventPayloadDescriptorCommand.payloadType should not be null" );
	...
	public void validate( UpdateEventPayloadDescriptorCommand eventPayloadDescriptor ) throws Exception {
		...
		Assert.notNull( eventPayloadDescriptor.getPayloadType(), "Field UpdateEventPayloadDescriptorCommand.payloadType should not be null" );
